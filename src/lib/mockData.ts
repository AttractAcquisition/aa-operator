...
export const mockSprints: Sprint[] = [
  {
    ...
    status: 'active', start_date: '2026-04-22', sprint_number: 8,
    leads_generated: 34, actual_ad_spend: 1680, client_ad_budget: 2100,
    revenue_attributed: 7200, bookings_from_sprint: 6,
    results_meeting_outcome: null, vertical: 'plumbing',
  },
  {
    id: 'spr_002', client_id: 'cli_002', client_name: 'Swift Electrical',
    status: 'active', start_date: '2026-04-27', sprint_number: 3,
    leads_generated: 11, actual_ad_spend: 680, client_ad_budget: 2100,
    revenue_attributed: null, bookings_from_sprint: 2,
    results_meeting_outcome: null, vertical: 'electrical',
  },
  {
    id: 'spr_003', client_id: 'cli_003', client_name: 'Leeds Roofing Co',
    status: 'active', start_date: '2026-04-19', sprint_number: 11,
    leads_generated: 28, actual_ad_spend: 2200, client_ad_budget: 2100,
    revenue_attributed: 4800, bookings_from_sprint: 4,
    results_meeting_outcome: null, vertical: 'roofing',
  },
  {
    id: 'spr_004', client_id: 'cli_004', client_name: 'Midlands HVAC',
    status: 'active', start_date: '2026-04-24', sprint_number: 6,
    leads_generated: 14, actual_ad_spend: 1570, client_ad_budget: 2100,
    revenue_attributed: null, bookings_from_sprint: 1,
    results_meeting_outcome: null, vertical: 'hvac',
  },
]
